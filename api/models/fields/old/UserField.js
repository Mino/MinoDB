public class UserField extends ValueField {
    ...
    public UserField(JSONObject parametersJSON, boolean forSearch) throws ValidatorError {
        ...
        if (parametersJSON != null) {
            ...
            if (equalTo != null) {
                ...
                } else if (!Common.isValidUsername(equalTo)) {
                    fieldErrors.getOrMakeInvalid().put("Equal To", new ValidatorError(53).error);
                }
    ...
    public void addToQuery(BoolFilterBuilder bqb, String fieldPrefix, String fieldName, Condition condition) {
        ...
        if (equalTo != null) {
            condition.cost += SearchRequestHandler.costPerFilter;
            bqb.must(FilterBuilders.queryFilter(QueryBuilders.termQuery(fieldPrefix + fieldName, equalTo)));
        }
        if (caseInsensitiveEqualTo != null) {
            condition.cost += SearchRequestHandler.costPerFilter;
